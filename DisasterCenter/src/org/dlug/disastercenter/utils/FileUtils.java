...
public final class FileUtils {
    ...
    public static String convertFileSizeFormat(long fileSize) {
		String fileUnit = "byte";
		
		if ( fileSize >= 1024 ) {
			double dFileSize = fileSize / 1024;
			fileUnit = "kbyte";
			...
			String formatValue = String.format("%.2f%s", dFileSize, fileUnit);

			return formatValue.replace(".00", "");
		}
