...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	public final void setEmptyView(View newEmptyView) {
		...
		if (null != mEmptyView) {
			ViewParent oldEmptyViewParent = mEmptyView.getParent();
			if (null != oldEmptyViewParent && oldEmptyViewParent instanceof ViewGroup) {
				((ViewGroup) oldEmptyViewParent).removeView(mEmptyView);
			}
		}
